...
public class Rumble extends Command {
  ...
  private final DoubleSupplier m_rumble1;
  private final DoubleSupplier m_rumble2;
   ...
   */
  public Rumble(DoubleSupplier rumbleL, DoubleSupplier rumbleR) {
    m_rumble1 = rumbleL;
    m_rumble2 = rumbleR;
  }
  ...
  public void execute() {
    ...
    m_joystick.setRumble(RumbleType.kRightRumble, m_rumble1.getAsDouble());
    m_joystick.setRumble(RumbleType.kLeftRumble, m_rumble2.getAsDouble());
  }
